...
/*  Example
	player createDiaryRecord ["", //Container
		[
			"", //Subsection
				"
				Welcome to s3kShUn61 Gaming!<br/><br/>
				"
		]
	];
*/
...
player createDiarySubject ["admins","Admins"];

	player createDiaryRecord["changelog",
		[
			"1.0 Release",
				"
					Coffee Breakfast Auth:___pyro___ clock</br>
					-Player Menu Saving<br/>
					-Clothing Shops Re Named<br/>
					-Grape/Moonshine fields moved<br/>
					-Deleted Freight Missions(Exploit City Sorry)<br/>
					-Fixed Donator shops (weapons)<br/>
					-Mystery Gold Wrecks Moved<br/>
					-Flashbangs added and nerfed<br/>
					-Clothing Shop Prices Lowered<br/>
					-Gun Stores Moved<br/>
					-Surrender is now shift+b<br/>
					-Weight of Gold Changed<br/>
					-Hunters no longer spawn with items inside<br/>
					-Loading Screen PostCard style :)<br/>
					-Holstering HANDGUNS ONLY shift+h<br/>
					-Cop Saving Working<br/>
					-Blue Tags Added For Cops<br/>
					-Police Uniforms<br/>
					-Treasure Hunting<br/>
					-Turtle Poaching Moved<br/>
					-Mystery Gold Processor Added<br/>
					-Sell Array values set to 0<br/>
					-Cop Paycheck 8000 Civ Paycheck 5000<br/>
					-Rule Billboards<br/>
					-More Hospitals<br/>
					-Easter Eggs Added<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord["changelog",
		[
			"1.1 Release",
				"
					Death Espresso Auth:___pyro___ clock</br>
					-Suppressors Added to Sgt Police Shop<br/>
					-Treasure Outpost Improved<br/>
					-Map buildings added<br/><br/>
				"
		]
	];
		...
		[
			"Exploits", 
				...
				5. Abusing safe zones to avoid role play or getting killed/caught.<br/>
	...
	player createDiaryRecord["safezones",
		[
			"Safe Zones",
				"
					If bombing (bombing can be intentionally exploding a vehicle), robbing, or killing that occurs in or around these areas is punishable by ban.<br/><br/>
					
					Any vehicle spawn (shop or garage Ex: Entire Airfield)<br/>
					Any weapon shop<br/>
					Any Place you can purchase an item<br/>
					All Police HQs<br/>
					Donator Shops<br/><br/>
				"
		]
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop Interaction", 
				...
				1. Civilians can be arrested for looking in cops' backpacks/vehicles. Constantly doing this will be considered trolling and result in your removal from the game.<br/>
				2. Civilians can be arrested/restrained for following cops in game in order to give away their position.<br/>
				3. Civilians or Rebels who take up arms to kill cops in town for no RP reason will be considered RDMing. See RDMing section.<br/>
				4. Following and or harassing cops for long periods of time will be considered griefing and/or trolling, and will result in your removal from the server.<br/>
				5. Actively hindering cops in any way from doing their duties can lead to your arrest. Constantly doing this will result in your removal from the server.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Aviation", 
				...
				2. Flying over a city constantly. Once is illegal, more than that you risk crashing into the city, thus against server rules.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Communication Rules", 
				...
				5. Civilians cannot be in any cop channels on teamspeak in order to gather information on their location or movements. Civs caught doing this will be removed from the channel. Repeat offenders can be kicked or banned from both the game and teamspeak.<br/>
				6. ts3.s3kShUn61Gaming.com come on in and we can setup a channel for you and your clan.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Random Deathmatching (RDM)", 
				...
				6. Shooting a player without giving reasonable time to follow demands is considered RDM.<br/>
				7. Requesting money to stop kililng civilians in town.<br/><br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				...
				5. If you purposefully kill yourself to avoid role play, it is not a new life.  Your warrents will remain active.<br/><br/>
				"
		]
	];
...
// Rebel Section
	player createDiaryRecord ["rebelrules",
		[
			"Border Rules",
				"
				1. Defending Rebels may KOS.<br/>
				2. Attacking Rebels may KOS.<br/>
				3. Police may never KOS defending or attacking rebels.<br/>
				4. Expect a fight if you control the border.<br/>
				5. Rebels are expected to role play when aspiring civilians drive through. As rebels you should protect the illegal population and drug trade. Killing unarmed drug mules will not improve your rep and is frowned upon.<br/>
				6. Defending Rebels may force civilians to pay charge a reasonable ammount in order to pass.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["rebelrules",
		[
			"Town Raids",
				"
				1. Raids must consist of a minimum 4 players.  The names of all raiding party must be texted to police 5 minute prior to raid starting.<br/>
				2. Players must have firearms displayed at all times during raid.<br/>
				3. Civilians may NOT be RDM'ed, roleplay is still required with civilans.<br/>
				4. Admins may end the raid if neither party is making progress.  If no admin is on, the highest ranking officer may negotiate the end of a raid for monetary gains to rebels<br/>
				"
		]
	];
// Police Section
	player createDiaryRecord ["policerules",
		[
			"Crisis Negotiation",
				"
				Crisis Negotiation must be handled by a Team Leader. If one is not available, the person with the next highest rank must handle the situation.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
		[
			"The Federal Reserve",
				"
				1. The Federal Reserve is illegal for civilians to enter. It is a kill on sight area.<br/>
				2. Helicopters flying over the Federal Reserve may be shot down without warning.<br/>
				2. If the Federal Reserve is getting robbed, wait for high command to dispatch team leaders to respond.<br/>
				3. Petty crimes can be dropped during a robbery.<br/>
				4. Lethal force on bank robbers may be used.<br/>
				5. Any civilian who actively makes an attempt to block the police from entering the building may be treated as an accomplice.<br/>
				6. Supervisory officers may hire individuals or contract a group of people to work as security guards for the bank. See 'Contracting' section for more information.<br/>
				7. The bank may only be robbed a minimum of 4 or more officers are online at the moment.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				"
				1. No helicopter can land within city limits without authorization from the highest ranking officer online Also you must be in Teamspeak3. (Exceptions being what is listed below.)<br/>
				...
				2. Police may forbid landing at a landing zone.<br/>
				3. Helicopters cannot hover over the city. Cops may only hover over the city if there is an active police operation going on.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Vehicles", 
				...
				7. Police speedboats or Hunters may be used to assist in apprehending criminals. Vehicles should be used to disable not to destroy.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Speeding", 
				...
				Inside town: 50km/h<br/>
				Outside town: 110km/h<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				...
				4. Martial law may not be declared at any time. Must be declared by SEU or above.<br/>
					Anyone found with a gun not holstered in a time of martial law will be neutralized.<br/>
				5. Police bases are illegal for civilians to enter. You may be restrained or arrested.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				The list is available at www.s3kShUn61Gaming.com<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons", 
				...
				Any other weapon (Including Silenced P07 and silencers [Considered a Police Weapon]) is illegal.<br/><br/>

				1. Civilians may have gun out(Primary) in any town but the clip must be removed.   Pistols must be holstered.<br/>
				...
				3. If you have a dispute come to the s3k TS3 server @ ts3.s3kshun61gaming.com <br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Less Lethal(Tazer) Force",
				"
				At this time the Taser (Silenced P07) and SDAR is the only form of Less Lethal Force aviable.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				1. In order to raid an area, the cops must have at least 4 officers involved, one of which must be a Sergeant or above.  If less than 4 cops are online, officers may solo raid areas to keep criminals in check.<br/>
				...
				2. See Bank Robbery sections for more info on camping in the main town.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Lethal Force",
				"
				1. Use of Lethal force is only permitted for the protection of your life, another officers life, or a civilians life, if and only if less lethal(Tazer) force would not be effective.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3 in a designated cop channel ts3.s3kshun61gaming.com. If an admin request that you come to Teamspeak and you decide to not come this will result in your immediate dismissal from the server.<br/>
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Take Drugs: Enjoy the ride.<br/>
				Left Shift + H: Holster your side arm.<br/><br/>
				"
		]
	];
...
// Admin Section
	...
	player createDiaryRecord ["Admins",
		[
			"",
				"
				Please note, arguing about rules or being disrespectful to any of the following will result in a bad time.  These are also the people to contact if you need assistance<br/>
				Clock<br/>
				s3kshun61<br/>
				Pyro<br/>
				Topgun<br/>
