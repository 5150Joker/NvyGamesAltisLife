...
life_cur_task setSimpleTaskDescription [format["You will bring this package to %1.",toUpper _dp],"Delivery Job",""];
life_cur_task setTaskState "Assigned";
player setCurrentTask life_cur_task;

["DeliveryAssigned",[format["Bring this package to %1",toUpper _dp]]] call bis_fnc_showNotification;
...
[] spawn
{
	...
	if(!alive player) then
	{
		...
		["DeliveryFailed",["You failed. Did not deliver package."]] call BIS_fnc_showNotification;
