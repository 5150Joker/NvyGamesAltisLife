...
switch (_shop) do
{
	case "market": {["Altis Market",["water","moonshine","vodka","apple","grapes","peach","rabbit","redgull","tbacon","lockpick","pickaxe","fuelF","burgers","storage2"]]};
	...
	case "rebel": {["Salt And Batteries",["lockpick","ziptie","water","rabbit","apple","redgull"]]};
};